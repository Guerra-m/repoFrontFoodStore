...
function renderCategories(categorias: ICategoria[]) {
  ...
  container.innerHTML = categorias
    .map((categoria) => {
      const productosCategoria = allProducts.filter(
        (p) => p.categoriaId === categoria.id && p.disponible
      );
  ...
  document.querySelectorAll(".category-header").forEach((header) => {
    header.addEventListener("click", (e) => {
      ...
      const toggle = (e.currentTarget as HTMLElement).querySelector(
        ".category-toggle"
      );
        ...
        <div class="product-info">
          ...
          <div class="product-footer">
            <div>
              ...
              ${
                cartQty > 0
                  ? `<div class="in-cart-badge">🛒 ${cartQty} en carrito</div>`
                  : ""
              }
            </div>
          </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-info">
            ...
            <div class="modal-stock-info">
              ...
              <span class="modal-stock">Stock total: ${
                product.stock
              } | Disponible para agregar: ${maxQuantity}</span>
              ${
                currentQtyInCart > 0
                  ? `<span class="modal-in-cart">Ya tienes ${currentQtyInCart} en el carrito</span>`
                  : ""
              }
            </div>
            ...
            ${
              ...
              <div class="modal-total">
                <span>Total:</span>
                <span id="modalTotal" class="modal-total-price">$${product.precio.toFixed(
                  2
                )}</span>
              </div>
